package com.api.duomo.validation;
...
public class ValidationMessages {
  ...
  public static final String REQUEST_PARAM_SIZE_MAX_ERROR_MESSAGE = "El atributo %s no debe tener más de {max} caracteres";
  ...
  public static final String REQUEST_PARAM_MIN_ERROR_MESSAGE = "El campo debe contener minimo {min} digito mayor a cero";

  public static final String REQUEST_PARAM_MAX_ERROR_MESSAGE = "El campo no debe ser mayor a {max}";
